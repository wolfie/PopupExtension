...
public class PopupExtension extends AbstractExtension {
    ...
    private final List<PopupVisibilityListener> listeners = new ArrayList<PopupVisibilityListener>();
    ...
    /**
     * <p> Attach and align the PopupExtension relative to the given component
     * </p>
     * <p>
     * <p> <i>Note:</i> Due to a workaround for Vaadin, PopupExtension needs to
     * place a data transfer component in your {@link UI UI's} content.
     * Therefore, that content needs to be an instance of {@link
     * ComponentContainer}. If that's not suitable, you can use {@link
     * #extendWithManualBundle(Component)} to manually place the data transfer
     * component. </p>
     *
     * @param c
     * @return
     ...
     *
     * @param c
     * @return an object containing the paired {@link PopupExtension} and {@link
     * PopupExtensionDataTransferComponent}.
     */
    ...
    public void detach() {
        if (dataTranserComponentIsMagicallyAdded) {
            AbstractSingleComponentContainer
                    .removeFromParent(dataTransferComponent);
        }
        super.detach();
    }
    ...
    /**
     * @return <code>true</code> iff the given <code>listener</code> was found

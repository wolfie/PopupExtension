...
public class PopupExtensionWidget extends VOverlay {
    ...
    private final List<VisibilityChangeListener> visibilityChangeListeners = new ArrayList<VisibilityChangeListener>();
    ...
    public void closeOnOutsideMouseClick(
            final boolean closeOnOutsideMouseClick) {
